  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="max-w-md w-full bg-white p-8 rounded-md shadow-lg">
        ...
        <p className="text-gray-600 mb-4">Ticket ID: 12d345c45</p>
        <div className="flex flex-col md:flex-row md:space-x-4">
          ...
          <button onClick={()=> route.push('parking')} className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded">
            Add Parking Space
          </button>
        </div>
      </div>
