      ...
      <div className="container px-6 mx-auto grid">
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-3">
          <SummaryCard 
            ...
            </div>} title='Complete Task' subtitle={counts.pending}/>
            <SummaryCard 
          ...
          </div>} title='Pending Task' subtitle={counts.completed}/>
        </div>
        <hr className="my-4"/>
            ...
            <table className="w-full whitespace-no-wrap">
              ...
              {data.map((task, index)=>(
                <tr key={index} className="text-gray-700">
                    ...
                    <td className="px-4 py-3 text-sm">
                        <button onClick={()=>window.my_modal_3.showModal()} className="px-2 py-1 text-xs font-bold text-white uppercase transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-600 focus:bg-gray-600 focus:outline-none">
                            Edit
                        </button>
                        <dialog id="my_modal_3" className="modal text-slate-800">
                          <form method="dialog" className="modal-box bg-slate-50">
                            <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                            <h3 className="font-bold text-lg">Edit Your Task Status</h3>
                            <hr className="my-2"/>
                            <p className='mt-3 flex flex-row space-x-4'>
