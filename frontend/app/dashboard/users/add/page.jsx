      ...
      <div className="container px-6 mx-auto grid">
        ...
        <form className="space-y-4" onSubmit={(e)=>submitForm(e)}>
          ...
          <div>
            ...
            <input type="text" id="email" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none"/>
          </div>
          <div>
            <label htmlFor="phone" className="block text-gray-600 font-semibold mb-1">
              Phone number
            </label>
            <input type="text" id="phone" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none"/>
          </div>
          <div>
            <label htmlFor="role" className="block text-gray-600 font-semibold mb-1">
              Role
            </label>
            <select id="role" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none">
          ...
          <div>
            ...
            <input type="password" id="password" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none"/>
          </div>
          <div>
            <label htmlFor="confirmpassword" className="block text-gray-600 font-semibold mb-1">
              Confirm Password
            </label>
            <input type="password" id="confirmpassword" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none"/>
          </div>
          <hr className="my-4"/>
