...
export default function Navbar() {
  ...
  return (
    <nav className='h-20 p-5 w-full flex justify-between items-center shadow-xl shadow-slate-100'>
      {/* title */}
      <div className='flex flex-row space-x-3 md:space-x-0'>
        ...
        <div className='flex flex-row space-x-2 md:space-x-4'>
          <div className='pr-3 pl-3 rounded-full border-2 hover:bg-slate-500 border-slate-700 items-center hover:text-cyan-700 hover:transition ease-in duration-200'>
              <BsCartDash onClick={()=>route.push('cart')} className='h-10 text-center'/>
              {/* <span className='absolute mt-0 font-black text-lg text-start'>0</span> */}
          </div>
          <div className='pr-3 pl-3 rounded-full border-2 hover:bg-slate-500 border-slate-700 text-center hover:text-cyan-700 hover:transition ease-in duration-200'>
            <BsFillPersonLinesFill className='h-10'/>
          </div>
        </div>
